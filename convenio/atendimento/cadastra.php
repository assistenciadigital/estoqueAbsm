  ...
  <form onsubmit="return validacampo(this)" action="processa.php<?php if ($_GET['id']) echo "?acao=alteracao"?>" name="frmcadastro" method="post">
    <table width="100%" border="0" align="center" cellpadding="3" cellspacing="3">
      ...
      <tr style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:12px">
        ...
        <td align="left" valign="middle" bgcolor="#CCCCCC"><input style="border:transparent; background:transparent" name="numero_guia" type="text" id="numero_guia" onfocus="this.value=razao.value" value="<?php if ($select['numero_guia']) echo $select['numero_guia']; else echo date(dmYHis);?>" size="20" maxlength="20" readonly="readonly"/></td>
      </tr>
      <tr style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:12px">
        <td align="right" valign="middle" bgcolor="#CCCCCC"><strong>Data da Guia de Encaminhamento:</strong></td>
        <td align="left" valign="middle" bgcolor="#CCCCCC"><input style="border:transparent; background:transparent" name="data_guia" type="text" id="data_guia" value="<?php if ($select['data_guia']) echo date_data($select['data_guia']); else echo date(dmY);?>" size="10" maxlength="auto" readonly="readonly" /></td>
      </tr>
      <tr style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:12px">
        <td align="right" valign="middle" bgcolor="#CCCCCC"><strong>Titular:</strong></td>
        <td align="left" valign="middle" bgcolor="#CCCCCC"><strong>
          <select style="border:transparent; background:transparent" name="titular" disabled="disabled" id="titular">
            <?php
      ...
      <tr style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:12px">
        ...
        <td align="left" valign="middle" bgcolor="#CCCCCC"><strong>
          <select style="border:transparent; background:transparent" name="dependente" disabled="disabled" id="dependente">
      ...
      <tr style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:12px">
        ...
        <td align="left" valign="middle" bgcolor="#CCCCCC"><strong>
          <input name="tipo" type="radio" disabled="disabled" value="MEDICA" <?php if($select['tipo_especialidade'] == "MEDICA") echo "checked" ?>/>
          Médica
          <input name="tipo" type="radio" disabled="disabled" value="ODONTOLOGICA" <?php if($select['tipo_especialidade'] == "ODONTOLOGICA") echo "checked" ?>/>
          Odontológica</strong></td>
      </tr>
      <tr style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:12px">
        <td align="right" valign="middle" bgcolor="#CCCCCC"><strong>Especialidade:</strong></td>
        <td align="left" valign="middle" bgcolor="#CCCCCC"><select style="border:transparent; background:transparent" name="especialidade" disabled="disabled" id="especialidade">
      ...
      <tr style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:12px">
        ...
        <td align="left" valign="middle" bgcolor="#CCCCCC"><input style="border:transparent; background:transparent" name="descricao" type="text" id="descricao" onfocus="this.value=razao.value" value="<?php echo $select['descricao']?>" size="80" maxlength="80" readonly="readonly"/></td>
      </tr>
      <tr style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:12px">
        <td align="right" valign="middle" bgcolor="#CCCCCC"><strong>Profissional: </strong></td>
        <td align="left" valign="middle" bgcolor="#CCCCCC"><select style="border:transparent; background:transparent" name="profissional" disabled="disabled" id="profissional">
      ...
      <tr style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:12px">
        ...
        <td align="left" valign="middle" bgcolor="#CCCCCC"><select style="border:transparent; background:transparent" name="origem" disabled="disabled" id="origem">
      ...
      <tr style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:12px">
        ...
        <td align="left" valign="middle" bgcolor="#CCCCCC"><select style="border:transparent; background:transparent" name="destino" disabled="disabled" id="destino">
      ...
      <tr style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:12px">
        ...
        <td align="left" valign="middle" bgcolor="#CCCCCC"><select style="border:transparent; background:transparent" name="motivo" disabled="disabled" id="motivo">
      ...
      <tr style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:12px">
        ...
        <td align="left" valign="middle" bgcolor="#CCCCCC"><input style="border:transparent; background:transparent" name="data_agenda" type="text" disabled="disabled" id="data_agenda" value="<?php if ($select['data_agenda']) echo date_data($select['data_agenda']); else echo date(dmY);?>" size="10" maxlength="auto" />
          <strong>Hora do Agendamento</strong>:
        <input style="border:transparent; background:transparent" name="hora_agenda" type="text" disabled="disabled" id="hora_agenda" value="<?php if ($select['hora_agenda']) echo date_data($select['hora_agenda']); else echo date(His);?>" size="10" maxlength="auto" /></td>
      </tr>
      <tr style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:12px">
        <td align="right" valign="middle" bgcolor="#CCCCCC"><strong>Observação:</strong></td>
        <td align="left" valign="middle" bgcolor="#CCCCCC"><input style="border:transparent; background:transparent" name="observacao" type="text" id="observacao" autocomplete="off" onfocus="this.value=razao.value" value="<?php echo $select['observacao']?>" size="80" maxlength="80" readonly="readonly"/></td>
      </tr>
      <tr style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:12px">
        <td align="right" valign="middle" bgcolor="#CCCCCC"><strong>Data do Atendimento:</strong></td>
        <td align="left" valign="middle" bgcolor="#CCCCCC"><input name="data_atende" type="text" id="data_atende" value="<?php if ($select['data_atende']) echo date_data($select['data_atende']); else echo date(dmY);?>" size="10" maxlength="auto" />
          <strong>Hora do Atendimento</strong>:
          <input name="hora_atende" type="text" id="hora_atende" value="<?php if ($select['hora_atende']) echo date_data($select['hora_atende']); else echo date(His);?>" size="10" maxlength="auto" /></td>
      </tr>
      <tr style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:12px">
        <td align="right" valign="middle" bgcolor="#CCCCCC"><strong>Status do Atendimento:</strong></td>
        <td align="left" valign="middle" bgcolor="#CCCCCC"><select name="status" id="status">
          <option value="">Status</option>
          <?php
            $select_status = mysql_query ("SELECT status_id, status_descricao FROM status where status_origem = 'ATENDIMENTO' ORDER BY status_descricao");
            if (mysql_num_rows ($select_status)) {
            while ($row_status = mysql_fetch_assoc($select_status)) {
            ?>
          <option value="<?php echo $row_status['status_id']?>"<?php if($select['status_atende'] == $row_status['status_id']) echo "selected"?>><?php echo $row_status['status_descricao']?></option>
          <?php }}?>
        </select></td>
      </tr>
      <tr style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:12px">
        ...
        <td align="left" valign="middle" bgcolor="#CCCCCC"><?php if ($_GET['id']){?>
          ...
          &nbsp;&nbsp;&nbsp;
          <?php } ?>
        <img src="../../imgs/bt_limpar.png" style="cursor:hand" onclick="limpa();"/>&nbsp;&nbsp;&nbsp;<a href="../agendamento/lista.php?titular=<?php echo $_GET['titular']?>"><img src="../../imgs/bt_voltar.png" border="0" /></a></td>
      </tr>
      </table>
  </form>
</div>
