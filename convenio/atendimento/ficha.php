...
if (mysql_num_rows ($select)) {
  while ($row = mysql_fetch_assoc($select)) {
	   ...
	   $pdf-> SetFont("Courier", 'B', 8);
	   $pdf-> Cell(0,4, 'ATENDIMENTO',1,1,'C');
...
$pdf->Output("ficha_atendimento.pdf", "I");
?> 
<script>window.open('ficha_atendimento.pdf'); </script>