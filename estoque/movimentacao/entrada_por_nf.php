...
<form onsubmit="return validacampo(this)" action="processa.php?acao=entrada_movimento_nf" name="frmcadastro" method="post">
...
<table width="100%" border="0" align="center" cellpadding="1" cellspacing="1">    
    <tr style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:12px">
      <td colspan="2" align="center" bgcolor="#00FFFF" scope="col"><strong>ENTRADA POR NOTA FISCAL</strong></td>
      </tr>
    <tr style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:12px">
    ...
    <tr style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:12px">
      ...
      <td width="50%" align="left"  bgcolor="#00FFFF" scope="col"><input name="documento" type="text" id="documento" value="<?php echo $_POST['documento']?>" /></td>
      </tr>
    <tr style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:12px">
      <td width="50%" align="right" bgcolor="#00FFFF" scope="col"><strong>Data Documento:</strong></td>
      <td width="50%" align="left"  bgcolor="#00FFFF" scope="col"><input name="datadocumento" type="text" id="datadocumento" value="<?php echo $_POST['datadocumento']?>" /></td>
      </tr>
    <tr style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:12px">
      <td width="50%" align="right" bgcolor="#00FFFF" scope="col"><strong>Valor Documento:</strong></td>
      <td width="50%" align="left"  bgcolor="#00FFFF" scope="col"><strong>
        <input name="valordocumento" type="text" id="valordocumento" onkeypress="return(adjustMoney(event,this,',','.'))" value="<?php echo $_POST['valordocumento']?>"/>
        </strong></td>
      </tr>
...
<table width="100%" border="0" align="center" cellpadding="1" cellspacing="1">    
    <tr style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:12px">
      ...
      <td width="10%" align="right"  bgcolor="#00FFFF" scope="col"><strong>Valor Documento</strong></td>
  ...
  if(!($_POST['fornecedor']) and !($_POST['documento']) and !($_POST['datadocumento']) and !($_POST['valordocumento'])){
	$select = mysql_query("SELECT movimento.movimento_id, movimento.movimento_origem, movimento.numero_documento, movimento.data_documento, movimento.valor_documento, movimento.usuario_login, movimento.data, fornecedor.fornecedor_razaosocial FROM movimento inner join fornecedor on movimento.movimento_origem = fornecedor.fornecedor_id where movimento.movimento_destino = 1  order by movimento.data_documento, movimento.valor_documento");
  }else{
	$select = mysql_query("SELECT movimento.movimento_id, movimento.movimento_origem, movimento.numero_documento, movimento.data_documento, movimento.valor_documento, movimento.usuario_login, movimento.data, fornecedor.fornecedor_razaosocial FROM movimento inner join fornecedor on movimento.movimento_origem = fornecedor.fornecedor_id where  movimento.movimento_origem = '".$_POST['fornecedor']."' and  movimento.numero_documento = '".$_POST['documento']."' and  movimento.data_documento = '".data_date($_POST['datadocumento'])."' and  movimento.valor_documento = '".formata_numero($_POST['valordocumento'],10,0,"valor")."' where movimento.movimento_destino = 1  order by movimento.data_documento, movimento.valor_documento");	  
  }
...
<table width="100%" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:12px">
      ...
      <td width="5%" align="center" valign="middle" bgcolor="<?php echo $cor?>" style="cursor:pointer" scope="col" onMouseOver="this.style.backgroundColor='#00FFFF'" onMouseOut="this.style.backgroundColor='<?php echo $cor?>'"><?php if(($_SESSION['nivel'])<=2){ ?><a href="continua_entrada_por_nf.php?movimento_id=<?php echo $row['movimento_id']?>"><img src="../../imgs/editar.png" width="20" height="20" /></a><?php } ?></td>
      <td width="5%" align="center" valign="middle" bgcolor="<?php echo $cor?>" style="cursor:pointer" scope="col" onMouseOver="this.style.backgroundColor='#00FFFF'" onMouseOut="this.style.backgroundColor='<?php echo $cor?>'"><?php if(($_SESSION['nivel'])<=2){ ?><a target="_blank" href="entrada_por_nf_pdf.php?movimento_id=<?php echo $row['movimento_id']?>"><img src="../../imgs/ico-printer.png" width="26" height="26"/></a><?php } ?></td>
    </tr>
  </table>
<?php }}?></div></p>
