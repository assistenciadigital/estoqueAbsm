...
<form onsubmit="return validacampo(this)" action="saida_por_transferencia.php" method="post" id="frmpesquisa">
<div style="border: 1px solid #c30; background: #ffe; font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:14px" align="center">
  <p><strong> SAIDA POR TRANSFERENCIA - DISPENSAÇÃO INTERNA</strong><p/>&nbsp;<input name="pesquisa" type="text" id="pesquisa" placeholder="Digite o que você está procurando e clique em Pesquisar" value="<?php echo $_POST['pesquisa']?>" size="50" maxlength="50" />&nbsp;<input type="submit" name="pesquisar" id="pesquisar" value="Pesquisar..." />
...
<form action="processa.php?acao=saida_por_transferencia" method="post" id="frmprocessa">
<div style="border: 1px solid #c30; background: #ffe; font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:12px" align="center">
  ...
  <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0"  class="pesquisa">
      ...
      <tr>
        <td align="right" valign="middle" bgcolor="#CCCCCC"> Local Destino:</td>
        <td align="left" valign="middle" bgcolor="#CCCCCC"><select name="local" id="local">
          <option value="">Informe o Local Estoque</option>
          <?php
      ...
      <tr>
        ...
        SAIDA POR TRANSFERENCIA - DISPENSAÇÃO</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td colspan="3" align="left" valign="middle" bgcolor="#CCCCCC"><input name="historico" type="text" id="historico" value="<?php echo "SAIDA POR TRANSFERENCIA - DISPENSACAO - EM: ".date('d/m/Y H:m')." USUARIO: ".$_SESSION['login'] ?>" size="160" /></td>
      </tr>
      <tr>
