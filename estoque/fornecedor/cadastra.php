...
if(($_SESSION['login']) AND ($_SESSION['nivel'])){
	...
	if ($_GET['id']) $titulo = "ALTERANDO FORNCEDOR";
				else $titulo = "CADASTRANDO FORNCEDOR";
		
	$select = @mysql_fetch_assoc(mysql_query("SELECT * FROM fornecedor where fornecedor_id = '".$_GET['id']."'"));
    ...
    <table width="100%" border="0" align="center" cellpadding="3" cellspacing="3">
      <tr style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:12px">
        ...
        <td width="80%" align="left" valign="middle" bgcolor="#CCCCCC"><label for="id"></label>
          <input style="border:transparent; background:transparent" name="id" type="text" id="id" value="<?php if ($_GET['id']) echo $select['fornecedor_id']; else echo 'registro novo';?>" size="20" maxlength="20" readonly="readonly" /></td>
        </tr>
      <tr style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:12px">
        <td align="right" valign="middle" bgcolor="#CCCCCC"><strong>Inscrição CPF ou CNPJ:</strong></td>
        <td align="left" valign="middle" bgcolor="#CCCCCC"><input name="inscricao" type="text" id="inscricao" value="<?php echo $select['fornecedor_inscricao']?>" size="20" maxlength="auto" onBlur="validar(this)"/></td>
      </tr>
      <tr style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:12px">
        <td width="20%" align="right" valign="middle" bgcolor="#CCCCCC"><strong>Razão Social:</strong></td>
        <td width="80%" align="left" valign="middle" bgcolor="#CCCCCC"><input name="razao" type="text" id="razao" value="<?php echo $select['fornecedor_razaosocial']?>" size="100" maxlength="auto" /></td>
        </tr>
      <tr style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:12px">
        <td align="right" valign="middle" bgcolor="#CCCCCC"><strong>Nome Fantasia:</strong></td>
        <td align="left" valign="middle" bgcolor="#CCCCCC"><input name="fantasia" type="text" id="fantasia" value="<?php echo $select['fornecedor_nomefantasia']?>" size="100" maxlength="auto" onfocus="this.value=razao.value"/></td>
        </tr>
      <tr style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:12px">
        <td align="right" valign="middle" bgcolor="#CCCCCC"><strong>CEP:</strong></td>
        <td align="left" valign="middle" bgcolor="#CCCCCC"><input name="cep" type="text" id="cep" value="<?php echo $select['fornecedor_cep']?>" size="12" maxlength="12" /></td>
      </tr>
      <tr style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:12px">
        <td align="right" valign="middle" bgcolor="#CCCCCC"><strong>Endereço Completo:</strong></td>
        <td align="left" valign="middle" bgcolor="#CCCCCC"><input name="endereco" type="text" id="endereco" value="<?php echo $select['fornecedor_endereco']?>" size="100" maxlength="auto" />
          Número:
            <input name="numero" type="text" id="numero" value="<?php echo $select['fornecedor_numero']?>" size="10" maxlength="auto" /></td>
      </tr>
      <tr style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:12px">
        <td align="right" valign="middle" bgcolor="#CCCCCC"><strong>Complemento:</strong></td>
        <td align="left" valign="middle" bgcolor="#CCCCCC"><input name="complemento" type="text" id="complemento" value="<?php echo $select['fornecedor_complemento']?>" size="60" maxlength="auto" /></td>
      </tr>
      <tr style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:12px">
        <td align="right" valign="middle" bgcolor="#CCCCCC"><strong>Bairro:</strong></td>
        <td align="left" valign="middle" bgcolor="#CCCCCC"><input name="bairro" type="text" id="bairro" value="<?php echo $select['fornecedor_bairro']?>" size="60" maxlength="auto" /></td>
      </tr>
      <tr style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:12px">
        ...
        <td align="left" valign="middle" bgcolor="#CCCCCC"><select name="uf" id="uf" style="width:50px; height: 20px;"	>
          ...
          <?php
            ...
            ?>
          <option value="<?php echo $row_uf['cidade_uf']?>"<?php if($select['fornecedor_uf'] == $row_uf['cidade_uf']) echo "selected"?>><?php echo $row_uf['cidade_uf']?></option>
          <?php }}?>
        </select>
        Cidade:
        <select name="cidade" id="cidade" style="width:353px; height: 20px;">
          ...
          <?php
            $select_cidade = mysql_query ("SELECT cidade_descricao FROM cidade WHERE cidade_uf = '".$select['fornecedor_uf']."' ORDER BY cidade_descricao");
            if (mysql_num_rows ($select_cidade)) {
            while ($row_cidade = mysql_fetch_assoc($select_cidade)) {
            ?>
          <option value="<?php echo $row_cidade['cidade_descricao']?>"<?php if($select['fornecedor_cidade'] == $row_cidade['cidade_descricao']) echo "selected"?>><?php echo $row_cidade['cidade_descricao']?></option>
          <?php }}?>
        </select></td>
      </tr>
      <tr style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:12px">
        <td align="right" valign="middle" bgcolor="#CCCCCC"><strong>Telefone:</strong></td>
        <td align="left" valign="middle" bgcolor="#CCCCCC"><input name="fone" type="text" id="fone" value="<?php echo $select['fornecedor_telefone']?>" size="15" maxlength="15" />
        Fax:
        <input name="fax" type="text" id="fax" value="<?php echo $select['fornecedor_fax']?>" size="15" maxlength="15" />
        Celular:
        <input name="celular" type="text" id="celular" value="<?php echo $select['fornecedor_celular']?>" size="15" maxlength="15" /></td>
      </tr>
      <tr style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:12px">
        <td align="right" valign="middle" bgcolor="#CCCCCC"><strong>E-mail:</strong></td>
        <td align="left" valign="middle" bgcolor="#CCCCCC"><input name="email" type="text" id="email" value="<?php echo $select['fornecedor_email']?>" size="60" maxlength="auto" /></td>
      </tr>
      <tr style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:12px">
        <td align="right" valign="middle" bgcolor="#CCCCCC"><strong>Responsável:</strong></td>
        <td align="left" valign="middle" bgcolor="#CCCCCC"><input name="autorizador" type="text" id="autorizador" value="<?php echo $select['fornecedor_responsavel']?>" size="100" maxlength="auto" /></td>
      </tr>
      <tr style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:12px">
        <td align="right" valign="middle" bgcolor="#CCCCCC"><strong>Função:</strong></td>
        <td align="left" valign="middle" bgcolor="#CCCCCC"><input name="funcao" type="text" id="funcao" value="<?php echo $select['fornecedor_funcao']?>" size="60" maxlength="auto" /></td>
      </tr>
      <tr style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:12px">
        <td align="right" valign="middle" bgcolor="#CCCCCC"><strong>Setor:</strong></td>
        <td align="left" valign="middle" bgcolor="#CCCCCC"><input name="setor" type="text" id="setor" value="<?php echo $select['fornecedor_depto']?>" size="60" maxlength="auto" /></td>
      </tr>
      <tr style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:12px">
