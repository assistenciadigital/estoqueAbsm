    ...
    <table width="100%" border="0" align="center" cellpadding="3" cellspacing="3">
      ...
      <tr style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:12px">
        ...
        <td align="left" valign="middle" bgcolor="#CCCCCC"><input name="lote" type="text" id="lote" value="<?php echo $select['produto_lote']?>" />
          ...
          <input name="validade" type="text" id="validade" value="<?php echo $select['produto_validade']?>" size="15" />&nbsp;&nbsp;<strong>Fabricante:</strong>
      ...
      <tr style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:12px">
        ...
        <td align="left" valign="middle" bgcolor="#CCCCCC"> <label for="dataentrada"></label>
          <input name="dataentrada" type="text" disabled="disabled" id="dataentrada" style="border: #FFFFFF; background:transparent" value="<?php if (empty($select['produto_data_entrada'])) echo date('d/m/Y H:m'); else echo datetime_datatempo($select['produto_data_entrada'])?>" size="16" maxlength="16" readonly="readonly" />&nbsp;<strong>Estoque Atual:</strong>&nbsp;
