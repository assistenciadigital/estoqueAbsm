...
if(($_SESSION['login']) AND ($_SESSION['nivel'])){
	...
	if ($_GET['id']) $titulo = "ALTERANDO PATENTE";
				else $titulo = "CADASTRANDO PATENTE";
		
	$select = @mysql_fetch_assoc(mysql_query("SELECT * FROM patente where patente_id = '".$_GET['id']."'"));
    ...
    <table width="100%" border="0" align="center" cellpadding="3" cellspacing="3">
      <tr style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:12px">
        ...
        <td width="80%" align="left" valign="middle" bgcolor="#CCCCCC"><label for="id"></label>
          <input style="border:transparent; background:transparent" name="id" type="text" id="id" value="<?php if ($_GET['id']) echo $select['patente_id']; else echo 'registro novo';?>" size="20" maxlength="20" readonly="readonly" /></td>
        </tr>
      <tr style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:12px">
        <td width="20%" align="right" valign="middle" bgcolor="#CCCCCC"><strong>Descrição:</strong></td>
        <td width="80%" align="left" valign="middle" bgcolor="#CCCCCC"><input name="descricao" type="text" id="descricao" value="<?php echo $select['patente_descricao']?>" size="60" maxlength="60" /></td>
        </tr>
      <tr style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:12px">
        <td align="right" valign="middle" bgcolor="#CCCCCC"><strong>Detalhe:</strong></td>
        <td align="left" valign="middle" bgcolor="#CCCCCC"><input name="detalhe" type="text" id="detalhe" value="<?php echo $select['patente_detalhe']?>" size="100" maxlength="100" /></td>
      </tr>
      <tr style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:12px">
        <td align="right" valign="middle" bgcolor="#CCCCCC"><strong>Ordem:</strong></td>
        <td align="left" valign="middle" bgcolor="#CCCCCC"><input name="ordem" type="text" id="ordem" class="frm_number_only" value="<?php echo $select['patente_ordem']?>" size="3" maxlength="3" /></td>
      </tr>
      <tr style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:12px">
