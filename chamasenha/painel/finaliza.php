...
if(($_SESSION['nivel_usuario'])<=2){
			$altera = mysql_query("UPDATE chamasenha SET chamado='".date('Y-m-d H:i:s')."', finalizado='".date('Y-m-d H:i:s')."', status='Ausente', data='".date('Y-m-d H:i:s')."', usuario='".$_SESSION['login']."' where id='".$_GET['id']."'");
